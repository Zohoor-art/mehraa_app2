...
//           ];
//         }
//       } else if (user.workType == 'google') {
//         if (isCurrentUser) {
//           newTabs = [const Tab(icon: Icon(Icons.person_2_sharp))];
//           newViews = [TaggedView(isCurrentUser: true)];
//         }
//       }
